pipeline {
  ...
  stages {
    ...
    sh 'mvn clean test sonar:sonar package'
      nexusPublisher nexusInstanceId: 'Nexus1', nexusRepositoryId: 'Maven_Repo1', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: '/var/lib/jenkins/workspace/project.spring.boot/spring_boot_project/target/spring-boot-aop-0.0.1-SNAPSHOT.jar']], mavenCoordinate: [artifactId: 'spring-boot-aop', groupId: 'com', packaging: 'jar', version: '0.0.1']]]
}
